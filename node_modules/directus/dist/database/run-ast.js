...
async function runAST(originalAST, schema, options) {
    ...
    async function run(collection, children, query) {
        ...
        const { columnsToSelect, primaryKeyField, nestedCollectionNodes } = await parseCurrentLevel(collection, children, schema);
        // The actual knex query builder instance. This is a promise that resolves with the raw items from the db
        const dbQuery = await getDBQuery(knex, collection, columnsToSelect, query, primaryKeyField, schema, options === null || options === void 0 ? void 0 : options.nested);
...
async function parseCurrentLevel(collection, children, schema) {
