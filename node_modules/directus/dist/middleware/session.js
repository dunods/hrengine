...
if (env_1.default.SESSION_STORE === 'redis') {
    ...
    const redisClient = new Redis(env_1.default.SESSION_REDIS || get_config_from_env_1.getConfigFromEnv('SESSION_REDIS_'));
    store = new RedisStore({ client: redisClient });
}
if (env_1.default.SESSION_STORE === 'memcache') {
    const MemcachedStore = require('connect-memcached')(express_session_1.default);
    store = new MemcachedStore(get_config_from_env_1.getConfigFromEnv('SESSION_MEMCACHE_'));
}
if (env_1.default.SESSION_STORE === 'database') {
    ...
    store = new KnexSessionStore({
        knex: database_1.default,
        tablename: 'oauth_sessions', // optional. Defaults to 'sessions'
    });
}
exports.session = express_session_1.default({ store, secret: env_1.default.SECRET, saveUninitialized: false, resave: false });
