 ...
 */
const authenticate = async_handler_1.default(async (req, res, next) => {
    var _a;
    req.accountability = {
        user: null,
        role: null,
    ...
    if ((_a = req.accountability) === null || _a === void 0 ? void 0 : _a.user) {
        await database_1.default('directus_users').update({ last_access: new Date() }).where({ id: req.accountability.user });
    }
    return next();
});
