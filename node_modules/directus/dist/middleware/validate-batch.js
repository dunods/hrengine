...
const validateBatch = (scope) => async_handler_1.default(async (req, res, next) => {
    ...
    if (scope === 'read' && req.body.query) {
        req.sanitizedQuery = sanitize_query_1.sanitizeQuery(req.body.query, req.accountability);
    }
    return next();
});
