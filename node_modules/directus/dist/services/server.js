...
class ServerService {
    ...
    async health() {
        ...
        const data = {
            ...
            checks: lodash_1.merge(...(await Promise.all([testDatabase(), testCache(), testRateLimiter(), testStorage(), testEmail()]))),
        };
        ...
        async function testDatabase() {
            ...
            if (await database_1.hasDatabaseConnection()) {
        ...
        async function testCache() {
            ...
            const startTime = perf_hooks_1.performance.now();
            try {
                await cache_1.default.set(`health-${checkID}`, true, 5);
                await cache_1.default.delete(`health-${checkID}`);
            }
            catch (err) {
        ...
        async function testEmail() {
            ...
            try {
                await (mailer_1.default === null || mailer_1.default === void 0 ? void 0 : mailer_1.default.verify());
            }
            catch (err) {
