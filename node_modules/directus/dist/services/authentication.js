...
class AuthenticationService {
    ...
    async authenticate(options) {
        ...
        let user = await database_1.default
        ...
        if (allowedAttempts !== null) {
            ...
            try {
                ...
                await database_1.default('directus_users').update({ status: 'suspended' }).where({ id: user.id });
        ...
        await database_1.default('directus_sessions').insert({
            token: refreshToken,
            user: user.id,
        ...
        await database_1.default('directus_sessions').delete().where('expires', '<', new Date());
    ...
    async refresh(refreshToken) {
        ...
        const record = await database_1.default
