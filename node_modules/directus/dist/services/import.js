...
class ImportService {
    ...
    importJSON(collection, stream) {
        ...
        return this.knex.transaction((trx) => {
            ...
            const saveQueue = async_1.queue(async (value) => {
        ...
        return this.knex.transaction((trx) => {
            ...
            return new Promise((resolve, reject) => {
                stream
                    ...
                    .on('data', (value) => {
                    const obj = lodash_1.transform(value, (result, value, key) => {
                        if (value.length === 0)
                            delete result[key];
                        else
                            lodash_1.set(result, key, value);
                    });
                    saveQueue.push(obj);
                })
                    .on('error', (err) => {
