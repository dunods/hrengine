...
class GraphQLService {
    ...
    async execute({ document, variables, operationName, contextValue, }) {
        ...
        let result;
        try {
            result = await graphql_1.execute({
                schema,
                document,
                contextValue,
            ...
            for (const collection of Object.values(schema[action].collections)) {
                ...
                CollectionTypes[collection.collection] = schemaComposer.createObjectTC({
                    ...
                    fields: Object.values(collection.fields).reduce((acc, field) => {
                        acc[field.field] = {
                            type: field.nullable ? get_graphql_type_1.getGraphQLType(field.type) : graphql_1.GraphQLNonNull(get_graphql_type_1.getGraphQLType(field.type)),
                ...
                if (Object.keys(creatableFields).length > 0) {
                    ...
                    CreateCollectionTypes[collection.collection].getResolver(`create_${collection.collection}_item`).addArgs({
                        ...CreateCollectionTypes[collection.collection]
                            ...
                            .getArgs(),
                        data: graphql_compose_1.toInputObjectType(CreateCollectionTypes[collection.collection]).setTypeName(`create_${collection.collection}_input`).NonNull,
                    });
                }
            }
    ...
    injectSystemResolvers(schemaComposer, { CreateCollectionTypes, ReadCollectionTypes, DeleteCollectionTypes, }, schema) {
        ...
        schemaComposer.Query.addFields({
            extensions: {
                ...
                resolve: async () => ({
                    interfaces: await extensions_1.listExtensions('interfaces'),
                    displays: await extensions_1.listExtensions('displays'),
                    layouts: await extensions_1.listExtensions('layouts'),
                    modules: await extensions_1.listExtensions('modules'),
                }),
            },
            server_specs_oas: {
        ...
        schemaComposer.Mutation.addFields({
            ...
            utils_hash_generate: {
                ...
                resolve: async (_, args) => {
                    return await argon2_1.default.hash(args.string);
                },
            },
            utils_hash_verify: {
                type: graphql_1.GraphQLBoolean,
