...
router.get('/', async_handler_1.default(async (req, res, next) => {
...
router.get('/:collection', collection_exists_1.default, async_handler_1.default(async (req, res, next) => {
    const service = new fields_1.FieldsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.get('/:collection/:field', collection_exists_1.default, async_handler_1.default(async (req, res, next) => {
    const service = new fields_1.FieldsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.patch('/:collection', collection_exists_1.default, async_handler_1.default(async (req, res, next) => {
    const service = new fields_1.FieldsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.patch('/:collection/:field', collection_exists_1.default, async_handler_1.default(async (req, res, next) => {
    const service = new fields_1.FieldsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.delete('/:collection/:field', collection_exists_1.default, async_handler_1.default(async (req, res, next) => {
    const service = new fields_1.FieldsService({
        accountability: req.accountability,
        schema: req.schema,
    });
