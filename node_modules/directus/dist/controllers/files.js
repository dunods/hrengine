...
router.post('/', multipartHandler, async_handler_1.default(async (req, res, next) => {
...
router.post('/import', async_handler_1.default(async (req, res, next) => {
...
router.patch('/:pk', multipartHandler, async_handler_1.default(async (req, res, next) => {
    const service = new services_1.FilesService({
        accountability: req.accountability,
        schema: req.schema,
    });
