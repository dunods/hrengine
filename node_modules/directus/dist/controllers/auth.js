...
router.post('/login', async_handler_1.default(async (req, res, next) => {
    var _a;
...
router.post('/refresh', async_handler_1.default(async (req, res, next) => {
    var _a;
    const accountability = {
        ip: req.ip,
        userAgent: req.get('user-agent'),
...
router.post('/logout', async_handler_1.default(async (req, res, next) => {
    var _a;
    const accountability = {
        ip: req.ip,
        userAgent: req.get('user-agent'),
...
router.post('/password/request', async_handler_1.default(async (req, res, next) => {
    if (!req.body.email) {
...
router.post('/password/reset', async_handler_1.default(async (req, res, next) => {
    if (!req.body.token) {
...
router.get('/oauth', async_handler_1.default(async (req, res, next) => {
...
router.get('/oauth/:provider', async_handler_1.default(async (req, res, next) => {
    var _a, _b;
...
router.get('/oauth/:provider/callback', async_handler_1.default(async (req, res, next) => {
    var _a, _b, _c;
    ...
    try {
        const email = get_email_from_profile_1.default(req.params.provider, (_a = req.session.grant.response) === null || _a === void 0 ? void 0 : _a.profile);
