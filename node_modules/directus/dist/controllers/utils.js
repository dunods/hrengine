...
router.get('/random/string', async_handler_1.default(async (req, res) => {
    var _a;
...
router.post('/hash/generate', async_handler_1.default(async (req, res) => {
    var _a;
    if (!((_a = req.body) === null || _a === void 0 ? void 0 : _a.string)) {
        throw new exceptions_1.InvalidPayloadException(`"string" is required`);
    }
    const hash = await argon2_1.default.hash(req.body.string);
    return res.json({ data: hash });
}));
router.post('/hash/verify', async_handler_1.default(async (req, res) => {
    var _a, _b;
    if (!((_a = req.body) === null || _a === void 0 ? void 0 : _a.string)) {
        throw new exceptions_1.InvalidPayloadException(`"string" is required`);
    }
...
router.post('/sort/:collection', collection_exists_1.default, async_handler_1.default(async (req, res) => {
...
router.post('/revert/:revision', async_handler_1.default(async (req, res, next) => {
...
router.post('/import/:collection', collection_exists_1.default, async_handler_1.default(async (req, res, next) => {
