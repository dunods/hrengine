...
async_handler_1.default(async (req, res, next) => {
    ...
    const file = await database_1.default.select('id', 'storage', 'filename_disk').from('directus_files').where({ id }).first();
    if (!file)
        throw new exceptions_1.ForbiddenException();
...
async_handler_1.default(async (req, res, next) => {
    ...
    const savedAssetSettings = await database_1.default
...
// Return file
async_handler_1.default(async (req, res) => {
    var _a, _b;
    const id = (_a = req.params.pk) === null || _a === void 0 ? void 0 : _a.substring(0, 36);
