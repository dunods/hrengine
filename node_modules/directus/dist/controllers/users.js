...
router.post('/', async_handler_1.default(async (req, res, next) => {
...
const readHandler = async_handler_1.default(async (req, res, next) => {
    const service = new services_1.UsersService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.get('/me', async_handler_1.default(async (req, res, next) => {
    var _a;
...
router.get('/:pk', async_handler_1.default(async (req, res, next) => {
...
router.patch('/me', async_handler_1.default(async (req, res, next) => {
    var _a;
    if (!((_a = req.accountability) === null || _a === void 0 ? void 0 : _a.user)) {
        throw new exceptions_1.InvalidCredentialsException();
    }
...
router.patch('/me/track/page', async_handler_1.default(async (req, res, next) => {
    var _a;
    if (!((_a = req.accountability) === null || _a === void 0 ? void 0 : _a.user)) {
        throw new exceptions_1.InvalidCredentialsException();
    }
...
router.patch('/', validate_batch_1.validateBatch('update'), async_handler_1.default(async (req, res, next) => {
    const service = new services_1.UsersService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.patch('/:pk', async_handler_1.default(async (req, res, next) => {
    const service = new services_1.UsersService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.delete('/', validate_batch_1.validateBatch('delete'), async_handler_1.default(async (req, res, next) => {
    const service = new services_1.UsersService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.delete('/:pk', async_handler_1.default(async (req, res, next) => {
    const service = new services_1.UsersService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.post('/invite', async_handler_1.default(async (req, res, next) => {
...
router.post('/invite/accept', async_handler_1.default(async (req, res, next) => {
...
router.post('/me/tfa/enable/', async_handler_1.default(async (req, res, next) => {
    var _a;
    if (!((_a = req.accountability) === null || _a === void 0 ? void 0 : _a.user)) {
        throw new exceptions_1.InvalidCredentialsException();
    }
...
router.post('/me/tfa/disable', async_handler_1.default(async (req, res, next) => {
    var _a;
    if (!((_a = req.accountability) === null || _a === void 0 ? void 0 : _a.user)) {
        throw new exceptions_1.InvalidCredentialsException();
    }
