...
router.post('/:collection', collection_exists_1.default, async_handler_1.default(async (req, res, next) => {
...
router.get('/:collection/:pk', collection_exists_1.default, async_handler_1.default(async (req, res, next) => {
    if (req.params.collection.startsWith('directus_'))
        throw new exceptions_1.ForbiddenException();
    if (req.singleton) {
        throw new exceptions_1.RouteNotFoundException(req.path);
...
router.patch('/:collection', collection_exists_1.default, validate_batch_1.validateBatch('update'), async_handler_1.default(async (req, res, next) => {
    if (req.params.collection.startsWith('directus_'))
        throw new exceptions_1.ForbiddenException();
    const service = new services_1.ItemsService(req.collection, {
        accountability: req.accountability,
...
router.patch('/:collection/:pk', collection_exists_1.default, async_handler_1.default(async (req, res, next) => {
    if (req.params.collection.startsWith('directus_'))
        throw new exceptions_1.ForbiddenException();
    if (req.singleton) {
        throw new exceptions_1.RouteNotFoundException(req.path);
...
router.delete('/:collection', collection_exists_1.default, validate_batch_1.validateBatch('delete'), async_handler_1.default(async (req, res, next) => {
    if (req.params.collection.startsWith('directus_'))
        throw new exceptions_1.ForbiddenException();
    const service = new services_1.ItemsService(req.collection, {
        accountability: req.accountability,
...
router.delete('/:collection/:pk', collection_exists_1.default, async_handler_1.default(async (req, res, next) => {
    if (req.params.collection.startsWith('directus_'))
        throw new exceptions_1.ForbiddenException();
    const service = new services_1.ItemsService(req.collection, {
        accountability: req.accountability,
