...
class InputTypeComposer {
    ...
    static createTemp(typeDef, schemaComposer) {
        ...
        if (is_1.isString(typeDef)) {
            ...
            ITC._gqcExtensions = (typeDef === null || typeDef === void 0 ? void 0 : typeDef.extensions) || {};
        }
        else {
    ...
    clone(newTypeNameOrTC) {
        ...
        cloned._gqcFields = misc_1.mapEachKey(this._gqcFields, (fieldConfig) => (Object.assign(Object.assign({}, fieldConfig), { extensions: Object.assign({}, fieldConfig.extensions) })));
