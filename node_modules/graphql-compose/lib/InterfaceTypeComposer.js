...
class InterfaceTypeComposer {
    constructor(graphqlType, schemaComposer) {
        ...
        if ((_a = graphqlType === null || graphqlType === void 0 ? void 0 : graphqlType.astNode) === null || _a === void 0 ? void 0 : _a.directives) {
            this.setExtension('directives', this.schemaComposer.typeMapper.parseDirectives((_b = graphqlType === null || graphqlType === void 0 ? void 0 : graphqlType.astNode) === null || _b === void 0 ? void 0 : _b.directives));
        }
    }
    ...
    extendField(fieldName, partialFieldConfig) {
        ...
        this.setField(fieldName, Object.assign(Object.assign(Object.assign({}, prevFieldConfig), partialFieldConfig), { extensions: Object.assign(Object.assign({}, (prevFieldConfig.extensions || {})), (partialFieldConfig.extensions || {})) }));
        return this;
    }
    ...
    clone(newTypeNameOrTC) {
        ...
        cloned._gqcFields = misc_1.mapEachKey(this._gqcFields, (fieldConfig) => (Object.assign(Object.assign({}, fieldConfig), { args: misc_1.mapEachKey(fieldConfig.args, (argConfig) => (Object.assign(Object.assign({}, argConfig), { extensions: Object.assign({}, argConfig.extensions) }))), extensions: Object.assign({}, fieldConfig.extensions) })));
