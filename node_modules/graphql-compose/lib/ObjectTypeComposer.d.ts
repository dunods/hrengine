...
import type { ObjMap, ThunkWithSchemaComposer, Extensions, ExtensionsDirective, DirectiveArgs } from './utils/definitions';
...
export declare type ObjectTypeComposerFieldConfigDefinition<TSource, TContext, TArgs = any> = ThunkWithSchemaComposer<ObjectTypeComposerFieldConfigAsObjectDefinition<TSource, TContext, TArgs>, SchemaComposer<TContext>> | ThunkWithSchemaComposer<ComposeOutputTypeDefinition<TContext>, SchemaComposer<TContext>> | Readonly<Resolver<any, TContext, any>>;
...
export declare class ObjectTypeComposer<TSource = any, TContext = any> {
    ...
    setFieldArgDirectives(fieldName: string, argName: string, directives: Array<ExtensionsDirective>): this;
