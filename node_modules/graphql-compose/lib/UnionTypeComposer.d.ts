...
import type { Thunk, Extensions, MaybePromise, ExtensionsDirective, DirectiveArgs } from './utils/definitions';
import { NamedTypeComposer } from './utils/typeHelpers';
import { SchemaPrinterOptions } from './utils/schemaPrinter';
export declare type UnionTypeComposerDefinition<TSource, TContext> = TypeAsString | TypeDefinitionString | UnionTypeComposerAsObjectDefinition<TSource, TContext> | GraphQLUnionType;
