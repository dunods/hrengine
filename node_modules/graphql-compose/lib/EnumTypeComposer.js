...
const keyMap_1 = __importDefault(require("graphql/jsutils/keyMap"));
...
class EnumTypeComposer {
    ...
    extendField(name, partialValueConfig) {
        ...
        const valueConfig = Object.assign(Object.assign({}, prevValueConfig), partialValueConfig);
    ...
    getType() {
        ...
        if (graphqlVersion_1.graphqlVersion >= 14) {
            ...
            gqType._nameLookup = keyMap_1.default(gqType._values, (value) => value.name);
        }
        else {
