...
export declare function printSpecifiedByUrl(type: GraphQLScalarType, options?: Options): string;
...
export declare function printArgs(_args: Array<GraphQLArgument>, options?: Options, indentation?: string): string;
...
export declare function printDeprecated(fieldOrEnumVal: {
