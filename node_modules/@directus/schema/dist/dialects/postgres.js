...
var Postgres = /** @class */ (function (_super) {
    ...
    Postgres.prototype.overview = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _c, columnsResult, primaryKeysResult, columns, primaryKeys, overview, _loop_1, _i, columns_1, column;
                    ...
                    case 1:
                        ...
                        _loop_1 = function (column) {
                            ...
                            overview[column.table_name].columns[column.column_name] = __assign(__assign({}, column), { default_value: column.is_identity === 'YES' || ((_b = column.default_value) === null || _b === void 0 ? void 0 : _b.startsWith('nextval('))
                                    ? 'AUTO_INCREMENT'
                                    : postgres_1.parseDefaultValue(column.default_value), is_nullable: column.is_nullable === 'YES' });
                        };
