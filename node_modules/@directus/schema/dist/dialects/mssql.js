                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _loop_1 = function (column) {
                            ...
                            overview[column.table_name].columns[column.column_name] = __assign(__assign({}, column), { default_value: column.is_identity ? 'AUTO_INCREMENT' : mssql_1.parseDefaultValue(column.default_value), is_nullable: column.is_nullable === 'YES' });
                        };
